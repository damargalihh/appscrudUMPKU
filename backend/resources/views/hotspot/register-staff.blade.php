...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Daftar Hotspot - Staff - UMPKU Surakarta</title>
            ...
            <div class="w-full max-w-md">
                <div class="glass-card rounded-2xl p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h1 class="mt-4 text-lg font-semibold text-[#1a1a2e]">Register Staff</h1>
                        <p class="text-xs text-[#4a4a6a]">UMPKU Surakarta - Staff</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('hotspot.selfRegister') }}">
                        ...
                        {{-- Profile otomatis StaffMagang --}}
                        <input type="hidden" name="profile" value="StaffMagang">
                    ...
                    <a href="{{ route('hotspot.googleRegister', ['profile' => 'StaffMagang']) }}"
