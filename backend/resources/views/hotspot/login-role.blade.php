...
<head>
    ...
    <title>Login WiFi {{ $roleData['label'] }} — UMPKU Surakarta</title>
    ...
    @php
        $colors = [
            'blue'    => ['bg' => '#eff6ff', 'text' => '#1d4ed8', 'border' => '#bfdbfe', 'hover' => '#dbeafe', 'gradient_from' => '#eff6ff', 'gradient_to' => '#e0e7ff', 'accent' => '#3b82f6'],
            'emerald' => ['bg' => '#ecfdf5', 'text' => '#047857', 'border' => '#a7f3d0', 'hover' => '#d1fae5', 'gradient_from' => '#ecfdf5', 'gradient_to' => '#d1fae5', 'accent' => '#10b981'],
            'purple'  => ['bg' => '#f5f3ff', 'text' => '#6d28d9', 'border' => '#c4b5fd', 'hover' => '#ede9fe', 'gradient_from' => '#f5f3ff', 'gradient_to' => '#ede9fe', 'accent' => '#8b5cf6'],
            'amber'   => ['bg' => '#fffbeb', 'text' => '#b45309', 'border' => '#fcd34d', 'hover' => '#fef3c7', 'gradient_from' => '#fffbeb', 'gradient_to' => '#fef3c7', 'accent' => '#f59e0b'],
        ];
        $c = $colors[$roleData['color']] ?? $colors['amber'];
    @endphp
        ...
        <div class="w-full max-w-md">
            <div class="glass-card rounded-3xl shadow-2xl p-6 sm:p-8 fade-up">
                ...
                <div class="text-center mb-6">
                    ...
                    {{-- Role Badge --}}
                    <div class="mt-3 inline-flex items-center gap-2 px-4 py-1.5 rounded-full border text-xs font-semibold role-badge">
                ...
                {{-- Register Link — langsung ke register sesuai role --}}
                <div class="fade-up fade-up-delay-3">
                    <a href="/register-hotspot/{{ $role }}" class="register-btn">
            ...
            {{-- Back & Admin Links --}}
            <div class="flex items-center justify-between mt-5 fade-up fade-up-delay-3 px-2">
                <a href="/hotspot/login" class="inline-flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-600 transition-colors">
                    <i class="fas fa-arrow-left text-[9px]"></i> Pilih Jaringan
                </a>
